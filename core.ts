/*Task 1 Movie class 
creation--description details for movie class
...
class Movie{
  ...
  //a)
  constructor (movieTitle : string , movieStudio : string , /* b) */movieRating : string="PG"){
    this.title=movieTitle;
    this.studio=movieStudio;
    this.rating=movieRating;
  }

  getPG(movieList : Array<Movie>):Array<Movie>{

    return (movieList.filter((value)=>{
      return value.rating=="PG";
    }));
  }
